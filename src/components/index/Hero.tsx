      ...
      <section className="max-w-4xl w-full flex flex-col mx-auto pt-44">
        ...
        >
          <h1 className="font-leaguespartan font-bold lg:text-7xl md:text-6xl sm:text-5xl text-4xl text-text">
            Hey, I&apos;m Zuxie
            <span className="sm:hidden inline-block animate-wave ml-2">👋</span>
            <span className="font-leaguespartan font-bold text-xl text-text brightness-50 italic sm:inline flex">
              {" "}
              aka Danzuxie!
            </span>
            ...
            {inView && (
              <Typewriter
                options={{
                  delay: 30,
                  strings: [
                    "I'm an 15 year old full-stack developer located in Indonesia",
                  ],
                  loop: false,
                  autoStart: true,
