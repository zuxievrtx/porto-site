  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Zuxie's (aka Nigger Slayer) personal site"
        />
        <meta
          property="og:image"
      ...
      <main className="flex h-screen flex-col justify-center pattern-grid-lg text-primary overflow-x-hidden">
        <div className="max-w-5xl w-full mx-auto">
          <h1
            ...
            } text-white font-bold sm:text-6xl text-4xl font-leaguespartan text-center`}
          >
            Welcome back, Zuxie 👋
          </h1>
          <div
            className={`${
              pageLoad ? "animate-fade-in-bottom" : "opacity-0"
            } w-1/2 mx-auto pt-8`}
          >
            <label
              htmlFor="search"
